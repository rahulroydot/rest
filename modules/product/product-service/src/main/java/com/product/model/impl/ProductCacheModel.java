...
public class ProductCacheModel implements CacheModel<Product>, Externalizable {
	...
	public Product toEntityModel() {
		...
		productImpl.setProductCost(productCost);
		...
		if (field1 == null) {
			productImpl.setField1("");
		}
		else {
			productImpl.setField1(field1);
		}

		productImpl.setField2(field2);
		productImpl.setField3(field3);

		if (field4 == Long.MIN_VALUE) {
			productImpl.setField4(null);
		}
		else {
			productImpl.setField4(new Date(field4));
		}

		if (field5 == null) {
			productImpl.setField5("");
		}
		else {
			productImpl.setField5(field5);
		}
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		productCost = objectInput.readLong();
	...
	public void writeExternal(ObjectOutput objectOutput) throws IOException {
		...
		objectOutput.writeLong(productCost);
